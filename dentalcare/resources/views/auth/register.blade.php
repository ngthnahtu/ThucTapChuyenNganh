                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Dùng để đăng nhập" required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            <label for="age" class="col-md-4 col-form-label text-md-end">{{ __('Tuổi') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" class="form-control" rows="3" required placeholder="Nhập địa chỉ chi tiết của bạn"></textarea>
                            </div>
                        </div>
