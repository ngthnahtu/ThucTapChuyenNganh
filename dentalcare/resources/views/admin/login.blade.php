                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Mừng Bạn Trở Lại!</h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Lưu Thông Tin</label>
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                        <a href="{{route('admin')}}" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Đăng nhập bằng Google
                                        </a>
                                        <a href="{{route('admin')}}" class="btn btn-facebook btn-user btn-block">
